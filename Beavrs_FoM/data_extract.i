...
tally_variable="heat_source"
tally_rel_error_variable="heat_source_rel_error"
variables="${tally_variable} ${tally_rel_error_variable} FoM"
...
[AuxKernels]
    ...
    [load_test_fom]
        ...
        from_variable = FoM
    []
    [load_test_clustering_id]
        type= SolutionAux
        solution = test_sln_user_obj
        variable = cluster_same_heating
        from_variable = cluster_same_heating
    []
    [load_ref_sln_mean]
        type= SolutionAux
        solution = ref_sln_user_obj
...
[UserObjects]
    ...
    [test_sln_user_obj]
        ...
        system_variables = "${variables} cluster_same_heating"
    []
[]
...
[VectorPostprocessors]
  [csv_data_extractor]
    ...
    sort_by = "x"
    variable = "test_FoM ref_FoM test_mean ref_mean test_rel_stat_error ref_rel_stat_error z_score cluster_same_heating"

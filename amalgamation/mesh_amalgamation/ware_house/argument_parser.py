...
def argument_parser():
    ...
    arg_parser.add_argument("-y_max", dest="y_max", type=float, default=300.0, help="Maximum y dimension.")
    arg_parser.add_argument("-z_min", dest="z_min", type=float, default=0.0, help="Minimum z dimension.")
    arg_parser.add_argument("-z_max", dest="z_max", type=float, default=300.0, help="Maximum z dimension.")

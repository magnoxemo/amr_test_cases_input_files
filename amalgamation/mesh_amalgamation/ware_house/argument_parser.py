...
def argument_parser():
    ...
    arg_parser.add_argument('-Nx', dest="Nx", type=int, default=10,
                            help="Number of segments in x direction.")
    arg_parser.add_argument('-Ny', dest="Ny", type=int, default=2,
                            help="Number of segments in y direction.")
    arg_parser.add_argument('-Nz', dest="Nz", type=int, default=2,
    ...
    arg_parser.add_argument("-x_min", dest="x_min", type=float, default=-100.0, help="Minimum x dimension.")
    arg_parser.add_argument("-x_max", dest="x_max", type=float, default=300.0, help="Maximum x dimension.")

...
pins_per_axis = 3.0
fuel_center = openmc.ZPlane(z0 = 0.0, boundary_type = 'vacuum')
fuel_top = openmc.ZPlane(z0 = 2*geom.core_height, boundary_type='vacuum')
...
core_assembly.pitch = (geom.pitch, geom.pitch, 2*geom.core_height / args.n_axial)
...
#--------------------------------------------------------------------------------------------------------------------------#
# Setup the model.
mult_pincell_model = openmc.Model(geometry = openmc.Geometry(openmc.Universe(cells = [core_assembly_cell])))
